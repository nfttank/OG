...
const Rules = (props) => (
  <div className="og__faq section__padding">
    <div className="og__faq-content">
      ...
      <p>Yes. Every OG token represents a number from 1 to 9999.<br/>
      ...
      <p>Most people might think that token <b>1</b> should be superior to token <b>9999</b> but it's up to everyone.<br/>
